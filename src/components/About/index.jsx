            ...
            <div className="w-full min-h-[665px] lg:flex lg:space-x-12 items-center pb-10 lg:pb-0">
              ...
              <div className="content flex-1">
                <h1 className="text-[18px] font-medium text-qblack mb-2.5">
                  What is Happy pet House?
                </h1>
                <p className="text-[15px] text-qgraytwo leading-7 mb-2.5">
                  Welcome to our online pet store! We specialize in providing a
                  wide range of supplies for rare and exotic pets. No matter
                  what unique pet you have, we have products tailored to their
                  needs, from luxurious habitats to specialized dietary
                  supplements. We guarantee product quality and offer excellent
                  customer service, ready to answer any questions you may have.
                  Browse our store now and find the perfect supplies for your
                  special companion!
                </p>
            ...
            <SimpleSlider selector={slider} settings={settings}>
              <div className="item h-[385px] bg-primarygray sm:px-10 sm:py-9 p-2">
                <div className="flex flex-col justify-between h-full">
                  ...
                  <div className="text-[15px] text-qgraytwo leading-[30px] text-justify line-clamp-6">
                    Absolutely thrilled with my experience shopping at this
                    online pet store! As a proud owner of some rather uncommon
                    pets, I often struggle to find suitable supplies, but this
                    store had everything I needed and more. The quality of the
                    products is top-notch, and the customer service team was
                    incredibly helpful in answering my questions. I'll
                    definitely be coming back for all my pet supply needs in the
                    future!
                  </div>
              ...
              <div className="item h-[385px] bg-primarygray sm:px-10 sm:py-9 p-2">
                <div className="flex flex-col justify-between h-full">
                  ...
                  <div className="text-[15px] text-qgraytwo leading-[30px] text-justify line-clamp-6">
                    I stumbled upon this online pet store while searching for
                    unique supplies for my exotic pets, and I'm so glad I did!
                    The variety of products available here is impressive, and I
                    found exactly what I was looking for. The ordering process
                    was seamless, and my items arrived quickly and in perfect
                    condition. I highly recommend this store to any pet owner
              ...
              <div className="item h-[385px] bg-primarygray sm:px-10 sm:py-9 p-2">
                <div className="flex flex-col justify-between h-full">
                  ...
                  <div className="text-[15px] text-qgraytwo leading-[30px] text-justify line-clamp-6">
                    Five stars all around for this fantastic online pet store!
                    As a devoted pet parent to a rare species, I'm always on the
                    lookout for specialized supplies, and this store exceeded my
                    expectations. Not only do they offer a comprehensive
                    selection of products, but the quality is unmatched. The
                    team behind the store is clearly passionate about animals
                    and provided exceptional service. I won't hesitate to return
                    for all my pet care needs.
                  </div>
                  <div className="flex items-center space-x-2.5 mt-3">
                    <div className="w-[50px] h-[50px] rounded-full overflow-hidden">
                      <img
